...
navigationMenu();
const navAnchors = navigation__list.querySelectorAll('a'); //It's a global variable now, after creating it in navigationMenua fn and appending it
 ...
 */
const linkScrollToTopBtn = (event) => {
...
// TODO: scroll to te appropriate section on navAnchor click.
for (const sectionTag of allSections) {
    for (const navAnchor of navAnchors) {
        if (navAnchor.innerHTML===sectionTag.getAttribute('data-navigation')) {
